...
import { createSession, destroySession, SESSION_COOKIE_NAME, sessionCookieOptions, } from "../auth/session.js";
import { isAccountLocked, recordFailedLogin, resetFailedLogins, logLoginAttempt, } from "../auth/rateLimiter.js";
...
authRoutes.post("/login", async (c) => {
    ...
    if (await isAccountLocked(user.id)) {
        ...
        return c.json({ error: "Akun terkunci sementara karena terlalu banyak percobaan gagal. Coba lagi nanti." }, 423);
    }
